...
{
    public partial class beyazdis_page : System.Web.UI.Page
    {
        ...
        protected void btnAddToCart_ServerClick(object sender, EventArgs e)
        {
            ...
            string inCartCheck = "Select * from inCart where bookID=10 and ID=@ID";
            ...
            else
            {
                ...
                {
                    con.Open();
                    String insertQuery = "Insert into inCart values(@ID,10)";
