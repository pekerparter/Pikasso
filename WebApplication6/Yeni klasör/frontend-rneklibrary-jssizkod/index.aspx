<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WebApplication6.Yeni_klasör.frontend_rneklibrary_jssizkod.index" %>
...
<body>
      ...
      <div class="container">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
              <ul class="navbar-nav fw-bold">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="../test_login.aspx" target="_self">  <!-- THIS IS NOT WORKING -->
                          <i class="fas fa-sign-in-alt"></i> Login
                      </a>
                  </li>

                  <li class="nav-item" style="position: relative;">
                      <a class="nav-link" id="off" href="../test_login.aspx">
  ...
  <div id="book-carousel" class="carousel slide" data-bs-ride="carousel">
                  ...
                  <div id="bookList" class="py-3">
                      ...
                      <div class="bookCard" data-name="Suç ve Ceza" data-author="Fyodor Dostoyevski"
                          ...
                          <div class="bookDetails">
                              <h3>Crime nd Punishment</h3>
                              <p>Author: Fyodor Dostoyevski</p>
                              <p>Release Date: 1866</p>
                              <p>Price: 60TL</p>
                              <button class="odunc" id="suc"><a href="../test_login.aspx">BUY</a></button>
                          </div>
                      </div>
                      ...
                      <div class="bookCard" data-name="Karamazov Kardeşler" data-author="Fyodor Dostoyevski"
                          ...
                          <div class="bookDetails">
                              <h3>Karamazov Brothers</h3>
                              <p>Author: Fyodor Dostoyevski</p>
                              <p>Release Date: 1880</p>
                              <p>Price: 40TL</p>
                              <button class="odunc" id="karam"><a href="../test_login.aspx">BUY</a></button>
                          </div>
                      </div>
                      ...
                      <div class="bookCard" data-name="Beyaz Diş" data-author="Jack London"
                          ...
                          <div class="bookDetails">
                              ...
                              <p>Price: 40TL</p>
                              <button class="odunc" id="beyaz"><a href="../test_login.aspx">BUY</a></button>
                          </div>
                      </div>
                      ...
                      <div class="bookCard" data-name="Sefiller" data-author="Victor Hugo"
                          ...
                          <div class="bookDetails">
                              ...
                              <p>Price: 40TL</p>
                              <button class="odunc" id="Sefil"><a href="../test_login.aspx">BUY</a></button>
                          </div>
                      </div>
                      ...
                      <div class="bookCard" data-name="Madame Bovary" data-author="Gustave Flaubert"
                          ...
                          <div class="bookDetails">
                              ...
                              <p>Price: 40TL</p>
                              <button class="odunc" id="Madam"><a href="../test_login.aspx">BUY</a></button>
                          </div>
                      </div>
                      ...
                      <div class="bookCard" data-name="Anna Karenina" data-author="Leo Tolstoy"
                          ...
                          <div class="bookDetails">
                              ...
                              <p>Price: 40TL</p>
                              <button class="odunc" id="Anna"><a href="../test_login.aspx">BUY</a></button>
                          </div>
                      </div>
                      <div class="bookCard" data-name="Satranç" data-author="Stefan Zweig"
                          ...
                          <div class="bookDetails">
                              ...
                              <p>Price: 40TL</p>
                              <button id="Satranc" class="odunc"><a href="../test_login.aspx">BUY</a></button>
                          </div>
                      </div>
                      <!-- 1984 Kitabı -->
                      <div class="bookCard" data-name="1984" data-author="George Orwell" data-publication-date="1949"
                          ...
                          <div class="bookDetails">
                              ...
                              <p>Price: 40TL</p>
                              <button class="odunc" id="1984"><a href="../test_login.aspx">BUY</a></button>
                          </div>
                      </div>
                      ...
                      <div class="bookCard" data-name="Hayvan Çiftliği" data-author="George Orwell"
                          ...
                          <div class="bookDetails">
                              ...
                              <p>Price: 40TL</p>
                              <button class="odunc" id="hayvan"><a href="../test_login.aspx">BUY</a></button>
                          </div>
                      </div>
                      ...
                      <div class="bookCard" data-name="Baskerville Köpekleri" data-author="Arthur Conan Doyle"
                          ...
                          <div class="bookDetails">
                              ...
                              <p>Price: 40TL</p>
                              <button class="odunc" id="basker"><a href="../test_login.aspx">BUY</a></button>
                          </div>
                      </div>
          ...
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-md-6 py-3 my-5">
                      <h4>Quick Contact</h4>
                      <p><i class="fas fa-envelope"></i> Email: worm@wormy.com<br>
      ...
      <script src="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-beta2/js/bootstrap.min.js"></script>    </form>
</body>
</html>
