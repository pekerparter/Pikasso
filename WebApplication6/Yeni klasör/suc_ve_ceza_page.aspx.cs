...
{
    public partial class suc_ve_ceza_page : System.Web.UI.Page
    {
        ...
        protected void btnAddToCart_ServerClick(object sender, EventArgs e)
        {
            ...
            string inCartCheck = "Select * from inCart where bookID=1 and ID=@ID";
            ...
            else
            {
                ...
                {
                    con.Open();
                    String insertQuery = "Insert into inCart values(@ID,1)";
